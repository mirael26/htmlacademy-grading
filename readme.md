...
Каталог квестов с фильтрацией по жанрам, формой заявки и страницей контактов.

Используемые технологии: ``TypeScript``, ```React```, ```Redux```, ```Axios```

## Установка

* установите [NodeJS](https://nodejs.org/), если он еще не установлен
* скачайте проект архивом или с помощью команды: ```git clone https://github.com/mirael26/htmlacademy-grading```
